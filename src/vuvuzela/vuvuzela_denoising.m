...
input('Press ENTER to listen ORIGINAL SOUND');
wavplay(x(1:10*Fe),Fe);
fprintf(' OK\n');
input('Press ENTER to listen DENOISED SOUND');
wavplay(output_signal(1:10*Fe),Fe);
fprintf('OK\n');
fprintf('Write anti_vuvuzela.wa:');
wavwrite(output_signal,Fe,'anti_vuvuzela.wav');
fprintf('OK\n');
